    ...
    if (
     ...
     player.reduceLife(playerArcherLife)
      if(playerArcherLife<= 0 ){
        ...
        playerArcher.body.isStatic = false
        player.body.isStatic = false
        playerBase.body.isStatic = false
  ...
  for (var i = 0; i < computerArrows.length; i++) {
    ...
    if (
      ...
      if(computerArcherLife<= 0 ){
        ...
        computerArcher.body.isStatic = false
        computer.body.isStatic = false
       computerBase.body.isStatic = false
